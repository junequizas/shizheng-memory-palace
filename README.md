...
面向国考与贵州省考行测常识 / 政治理论复习的可拖拽知识网络。首版收录 69 个整理考点和 138 条人工关联，覆盖 2024-09-19 至 2026-09-19 的核心专题及必要背景。
...
`src/lib/originals.ts` 保存逐卡核对后的官方原文摘录，`src/lib/catalog.ts` 保存检索关键词、易错替换和知识关系。两者刻意分开，避免把应试概括误标成原文。事实来源逐卡链接到新华社、政府网站等公开原文。小黑时政目前只保留公开课程入口，未转录其付费或未核验内容。
